...
//	Identity
static const fp4 g_matrix4x4_x86_ident[16] = {
...
public:
  ...
  void Set(fp4 _m11, fp4 _m12, fp4 _m13, fp4 _m14, fp4 _m21, fp4 _m22, fp4 _m23,
           fp4 _m24, fp4 _m31, fp4 _m32, fp4 _m33, fp4 _m34, fp4 _m41, fp4 _m42,
           fp4 _m43, fp4 _m44);
  ...
  void PerspectiveLH(const fp4 _fovY, const fp4 _aspect, const fp4 _zn,
                     const fp4 _zf);
  void PerspectiveOffCenterLH(const fp4 _minX, const fp4 _maxX, const fp4 _minY,
                              const fp4 _maxY, const fp4 _zn, const fp4 _zf);
  ...
  void PerspectiveRH(const fp4 _fovY, const fp4 _aspect, const fp4 _zn,
                     const fp4 _zf);
  void PerspectiveOffCenterRH(const fp4 _minX, const fp4 _maxX, const fp4 _minY,
                              const fp4 _maxY, const fp4 _zn, const fp4 _zf);
...
inline void CMatrix4x4_x86::MultiplyFast(const CMatrix4x4_x86 &_m1)
{
  for (uint32 i = 0; i < 4; i++)
  {
    ...
    fp4 mi2 = m_Mat[i][2];
    m_Mat[i][0] =
        mi0 * _m1.m_Mat[0][0] + mi1 * _m1.m_Mat[1][0] + mi2 * _m1.m_Mat[2][0];
    m_Mat[i][1] =
        mi0 * _m1.m_Mat[0][1] + mi1 * _m1.m_Mat[1][1] + mi2 * _m1.m_Mat[2][1];
    m_Mat[i][2] =
        mi0 * _m1.m_Mat[0][2] + mi1 * _m1.m_Mat[1][2] + mi2 * _m1.m_Mat[2][2];
  }
...
/*
 */
inline void CMatrix4x4_x86::PerspectiveLH(const fp4 _fovY, const fp4 _aspect,
                                          const fp4 _zn, const fp4 _zf)
{
...
/*
 */
inline void CMatrix4x4_x86::PerspectiveRH(const fp4 _fovY, const fp4 _aspect,
                                          const fp4 _zn, const fp4 _zf)
{
  fp4 h = 1.0f / tanf(_fovY * 0.5f);
  fp4 w = h / _aspect;
...
/*
 */
inline void CMatrix4x4_x86::PerspectiveOffCenterLH(const fp4 _minX,
                                                   const fp4 _maxX,
                                                   const fp4 _minY,
                                                   const fp4 _maxY,
                                                   const fp4 _zn, const fp4 _zf)
...
/*
 */
inline void CMatrix4x4_x86::PerspectiveOffCenterRH(const fp4 _minX,
                                                   const fp4 _maxX,
                                                   const fp4 _minY,
                                                   const fp4 _maxY,
                                                   const fp4 _zn, const fp4 _zf)
...
/*
 */
inline void CMatrix4x4_x86::OrthographicLH(const fp4 _w, const fp4 _h,
                                           const fp4 _zn, const fp4 _zf)
{
  M11 = 2.0f / _w;
  M12 = 0.0f;
...
/*
 */
inline void CMatrix4x4_x86::OrthographicRH(const fp4 _w, const fp4 _h,
                                           const fp4 _zn, const fp4 _zf)
{
  M11 = 2.0f / _w;
  M12 = 0.0f;
                                       ...
                                       const CMatrix4x4_x86 &_m1)
{
  CMatrix4x4_x86 m2(
      ...
      _m0.m_Mat[0][0] * _m1.m_Mat[0][0] + _m0.m_Mat[0][1] * _m1.m_Mat[1][0] +
          _m0.m_Mat[0][2] * _m1.m_Mat[2][0] + _m0.m_Mat[0][3] * _m1.m_Mat[3][0],
      _m0.m_Mat[0][0] * _m1.m_Mat[0][1] + _m0.m_Mat[0][1] * _m1.m_Mat[1][1] +
          _m0.m_Mat[0][2] * _m1.m_Mat[2][1] + _m0.m_Mat[0][3] * _m1.m_Mat[3][1],
      _m0.m_Mat[0][0] * _m1.m_Mat[0][2] + _m0.m_Mat[0][1] * _m1.m_Mat[1][2] +
          _m0.m_Mat[0][2] * _m1.m_Mat[2][2] + _m0.m_Mat[0][3] * _m1.m_Mat[3][2],
      _m0.m_Mat[0][0] * _m1.m_Mat[0][3] + _m0.m_Mat[0][1] * _m1.m_Mat[1][3] +
          _m0.m_Mat[0][2] * _m1.m_Mat[2][3] + _m0.m_Mat[0][3] * _m1.m_Mat[3][3],

      _m0.m_Mat[1][0] * _m1.m_Mat[0][0] + _m0.m_Mat[1][1] * _m1.m_Mat[1][0] +
          _m0.m_Mat[1][2] * _m1.m_Mat[2][0] + _m0.m_Mat[1][3] * _m1.m_Mat[3][0],
      _m0.m_Mat[1][0] * _m1.m_Mat[0][1] + _m0.m_Mat[1][1] * _m1.m_Mat[1][1] +
          _m0.m_Mat[1][2] * _m1.m_Mat[2][1] + _m0.m_Mat[1][3] * _m1.m_Mat[3][1],
      _m0.m_Mat[1][0] * _m1.m_Mat[0][2] + _m0.m_Mat[1][1] * _m1.m_Mat[1][2] +
          _m0.m_Mat[1][2] * _m1.m_Mat[2][2] + _m0.m_Mat[1][3] * _m1.m_Mat[3][2],
      _m0.m_Mat[1][0] * _m1.m_Mat[0][3] + _m0.m_Mat[1][1] * _m1.m_Mat[1][3] +
          _m0.m_Mat[1][2] * _m1.m_Mat[2][3] + _m0.m_Mat[1][3] * _m1.m_Mat[3][3],

      _m0.m_Mat[2][0] * _m1.m_Mat[0][0] + _m0.m_Mat[2][1] * _m1.m_Mat[1][0] +
          _m0.m_Mat[2][2] * _m1.m_Mat[2][0] + _m0.m_Mat[2][3] * _m1.m_Mat[3][0],
      _m0.m_Mat[2][0] * _m1.m_Mat[0][1] + _m0.m_Mat[2][1] * _m1.m_Mat[1][1] +
          _m0.m_Mat[2][2] * _m1.m_Mat[2][1] + _m0.m_Mat[2][3] * _m1.m_Mat[3][1],
      _m0.m_Mat[2][0] * _m1.m_Mat[0][2] + _m0.m_Mat[2][1] * _m1.m_Mat[1][2] +
          _m0.m_Mat[2][2] * _m1.m_Mat[2][2] + _m0.m_Mat[2][3] * _m1.m_Mat[3][2],
      _m0.m_Mat[2][0] * _m1.m_Mat[0][3] + _m0.m_Mat[2][1] * _m1.m_Mat[1][3] +
          _m0.m_Mat[2][2] * _m1.m_Mat[2][3] + _m0.m_Mat[2][3] * _m1.m_Mat[3][3],

      _m0.m_Mat[3][0] * _m1.m_Mat[0][0] + _m0.m_Mat[3][1] * _m1.m_Mat[1][0] +
          _m0.m_Mat[3][2] * _m1.m_Mat[2][0] + _m0.m_Mat[3][3] * _m1.m_Mat[3][0],
      _m0.m_Mat[3][0] * _m1.m_Mat[0][1] + _m0.m_Mat[3][1] * _m1.m_Mat[1][1] +
          _m0.m_Mat[3][2] * _m1.m_Mat[2][1] + _m0.m_Mat[3][3] * _m1.m_Mat[3][1],
      _m0.m_Mat[3][0] * _m1.m_Mat[0][2] + _m0.m_Mat[3][1] * _m1.m_Mat[1][2] +
          _m0.m_Mat[3][2] * _m1.m_Mat[2][2] + _m0.m_Mat[3][3] * _m1.m_Mat[3][2],
