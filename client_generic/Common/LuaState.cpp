...
void CLuaState::Init(const std::string &_basePath)
{
  ...
  lua_cpcall(
      m_pState, luaopen_package,
      NULL); //	Package library. (we need this to be able to 'require' from lua)
  ...
  //	The following will be pre-registered, and only loaded explicitly from
  // the script.
