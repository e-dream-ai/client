...
echo "     → Upload to: https://infinidream.ai/alpha/appcast.xml (production)"
echo "                  https://infinidream.ai/stage/appcast.xml (stage)"
echo ""
...
echo "     - Production: https://infinidream.ai/alpha/appcast.xml"
echo "     - Stage: https://infinidream.ai/stage/appcast.xml"
