...
CDisplayOutput::CDisplayOutput()
    : m_XPosition(10), m_YPosition(10), m_Width(0), m_Height(0),
...
/*
 */
CDisplayOutput::~CDisplayOutput() { ClearEvents(); }
...
/*
 */
void CDisplayOutput::AppendEvent(spCEvent _event) { m_EventQueue.push(_event); }
