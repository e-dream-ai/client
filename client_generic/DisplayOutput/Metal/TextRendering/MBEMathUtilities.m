...
vector_float3 vector_orthogonal(vector_float3 v)
{
    ...
    return fabs(v.x) > fabs(v.z) ? (vector_float3){-v.y, v.x, 0.0}
                                 : (vector_float3){0.0, -v.z, v.y};
}
...
int _ahsdb(float left, float right, float top, float bottom) { return 0; }
matrix_float4x4 _matrix_orthographic_projection(float left, float right,
