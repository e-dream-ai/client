                     ...
                     device:(id<MTLDevice>)device
{
  ...
  [lines
      enumerateObjectsUsingBlock:^(id lineObject, __unused NSUInteger lineIndex,
                                   __unused BOOL *stop) {
        frameGlyphCount +=
  ...
  [self enumerateGlyphsInFrame:frame
        ...
        UniChar character = glyph;
                           ...
                           {
                             NSLog(@"Font atlas has no entry corresponding to "
                                   @"glyph #%d; Skipping...",
                                   glyph);
                             return;
                           }
    ...
    [runs enumerateObjectsUsingBlock:^(id runObject,
      ...
      for (size_t glyphIndex = 0; glyphIndex < glyphCount; ++glyphIndex)
      {
        ...
        CGFloat boundsTransY = NSHeight(frameBoundingRect) +
                               frameBoundingRect.origin.y - lineOrigin.y +
                               glyphOrigin.y;
        CGAffineTransform pathTransform =
            CGAffineTransformMake(1, 0, 0, -1, boundsTransX, boundsTransY);
