...
*/
LRESULT CALLBACK CWindowsGL::wndProc(HWND hWnd, UINT msg, WPARAM wParam,
                                     LPARAM lParam)
{
  PAINTSTRUCT ps;
...
bool CWindowsGL::Initialize(HWND _hWnd, bool _bPreview)
{
  ...
  if (_bPreview)
  {
    ...
    m_WindowHandle =
        CreateWindowEx(0, "Electricsheep", "Preview", WS_CHILD | WS_VISIBLE, 0,
...
*/
HWND CWindowsGL::Initialize(const uint32 _width, const uint32 _height,
