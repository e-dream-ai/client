                         ...
                         const bool _bFullscreen)
{
  ...
  m_Window = XCreateWindow(
      ...
      _bFullscreen ? m_WidthFS : m_Width, _bFullscreen ? m_HeightFS : m_Height,
  ...
  m_GlxContext = glXCreateNewContext(m_pDisplay, renderFBConfig, GLX_RGBA_TYPE,
                                     0, GL_TRUE);
  m_GlxWindow = glXCreateWindow(m_pDisplay, renderFBConfig, m_Window, 0);
...
void CUnixGL::checkClientMessages()
{
                        ...
                        &xEvent))
  {
    ...
    KeySym *keySymbol = XGetKeyboardMapping(m_pDisplay, xEvent.xkey.keycode, 1,
                                            &keysyms_per_keycode_returned);
