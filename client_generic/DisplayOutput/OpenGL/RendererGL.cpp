...
void CRendererGL::Verify(const char* /*_file*/, const int32 /*_line*/)
{
    ...
    msg = "GL_INVALID_FRAMEBUFFER_OPERATION_EXT"; else msg = "Unrecognized
    OpenGL error";
                                           ...
                                           const uint32 _flags)
{
    ...
    spCTextureFlat spTex = new CTextureFlatGL(
        _flags |
            ((GetTextureTargetType() == eTexture2DRect) ? kRectTexture : 0),
        cgl_ctx);
#else
    spCTextureFlat spTex = new CTextureFlatGL(
        _flags |
                           ...
                           const Base::Math::CRect& _uvrect)
{
    ...
    /*float vertices[]  = {r.m_X0, r.m_Y0, r.m_X1, r.m_Y0, r.m_X1, r.m_Y1,
    r.m_X0, r.m_Y1}; float texcoords[] = {_uvrect.m_X0, _uvrect.m_Y0,
    _uvrect.m_X1, _uvrect.m_Y0, _uvrect.m_X1, _uvrect.m_Y1, _uvrect.m_X0,
    _uvrect.m_Y1 };
