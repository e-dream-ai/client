...
Section "MainSection" SEC01
	...
	File "..\RuntimeMSVC\avcodec-58.dll"   ; for ffmpeg
	File "..\RuntimeMSVC\avformat-58.dll"  ; for ffmpeg
	File "..\RuntimeMSVC\avutil-56.dll"    ; for ffmpeg
	File "..\RuntimeMSVC\swresample-3.dll" ; for ffmpeg
	File "..\RuntimeMSVC\swscale-5.dll"    ; for ffmpeg
	File "..\RuntimeMSVC\libbz2-1.dll"     ; for ffmpeg
	File "..\RuntimeMSVC\libiconv-2.dll"   ; for ffmpeg
	File "..\RuntimeMSVC\libogg-0.dll"     ; for ffmpeg
	File "..\RuntimeMSVC\libopus-0.dll"    ; for ffmpeg
	File "..\RuntimeMSVC\libvorbis-0.dll"  ; for ffmpeg
	File "..\RuntimeMSVC\libkvazaar-6.dll" ; for ffmpeg
	File "..\RuntimeMSVC\libc++.dll"       ; for ffmpeg
	File "..\RuntimeMSVC\libcryptopp.dll"  ; for ffmpeg
	File "..\RuntimeMSVC\libgcc_s_seh-1.dll"  ; for ffmpeg
	File "..\RuntimeMSVC\liblzma-5.dll"    ; for ffmpeg
	File "..\RuntimeMSVC\libsnappy.dll"    ; for ffmpeg
	File "..\RuntimeMSVC\libsoxr.dll"      ; for ffmpeg
	File "..\RuntimeMSVC\libssp-0.dll"     ; for ffmpeg
	File "..\RuntimeMSVC\libstdc++-6.dll"  ; for ffmpeg
	File "..\RuntimeMSVC\libunwind.dll"    ; for ffmpeg
	File "..\RuntimeMSVC\libvorbisenc-2.dll"  ; for ffmpeg
	File "..\RuntimeMSVC\libvpx-1.dll"     ; for ffmpeg
	File "..\RuntimeMSVC\libwinpthread-1.dll"  ; for ffmpeg
	File "..\RuntimeMSVC\zlib1.dll"        ; for ffmpeg
	File "..\RuntimeMSVC\snappy.dll"       ; for ffmpeg
...
;delete ffmpeg;s dll
	...
	Delete "$WINDIR\libbz2-1.dll"
	Delete "$WINDIR\libiconv-2.dll"
	Delete "$WINDIR\libogg-0.dll"
	Delete "$WINDIR\libopus-0.dll"
	Delete "$WINDIR\libvorbis-0.dll"
	Delete "$WINDIR\libc++.dll"
	Delete "$WINDIR\libcryptopp.dll"
	Delete "$WINDIR\libkvazaar-6.dll"
	Delete "$WINDIR\libgcc_s_seh-1.dll"
	Delete "$WINDIR\liblzma-5.dll"
	Delete "$WINDIR\libsnappy.dll"
	Delete "$WINDIR\libsoxr.dll"
	Delete "$WINDIR\libssp-0.dll"
	Delete "$WINDIR\libstdc++-6.dll"
	Delete "$WINDIR\libunwind.dll"
	Delete "$WINDIR\libvorbisenc-2.dll"
	Delete "$WINDIR\libvpx-1.dll"
	Delete "$WINDIR\libwinpthread-1.dll"
	Delete "$WINDIR\zlib1.dll"
	Delete "$WINDIR\snappy.dll"
